--------------------------------------------------------
--  DDL for View VW_CLIENTE_MAQUINA_CHECKLIST
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "WS4TI"."VW_CLIENTE_MAQUINA_CHECKLIST" ("ID_CLIENTE", "CD_MAQUINA", "SQ_CHECKITEM", "DT_INICIO", "DT_TMP", "DS_MAQUINA", "ID_MAQUINA_GRUPO", "DS_MAQUINA_GRUPO", "NR_ORDEM", "DS_INSPECAO", "DS_OBS", "TP_RECORRENCIA", "ID_CKOS") AS 
